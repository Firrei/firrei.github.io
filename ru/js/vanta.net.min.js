!function(t, e) {
    ...
    a.VantaBase = class {
        constructor(t={}) {
            ...
            this.options.mouseControls && (o("scroll", this.windowMouseMoveWrapper),
            o("mousemove", this.windowMouseMoveWrapper)),
            this.options.touchControls && (o("touchstart", this.windowTouchWrapper),
        ...
        initThree() {
            ...
            this.scene = new h.Scene) : console.warn("[VANTA] No THREE defined on window")
        }
        getCanvasElement() {
    ...
    class d extends c {
        ...
        onInit() {
            ...
            this.camera = new p.PerspectiveCamera(25,this.width / this.height,.01,1e4),
        ...
        onUpdate() {
            ...
            for (let t = 0; t < this.points.length; t++) {
                ...
                if (l.scale.x = l.scale.y = l.scale.z = (.25 * (15 - c)).clamp(1, 100),
                0 !== l.r) {
